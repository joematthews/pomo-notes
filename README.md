...
> [!NOTE]  
> Pomo Notes assumes you have Bash installed on your machine (typically MacOS & Linux), but should work fine with Windows if using the Git Bash Terminal within VSCode.
